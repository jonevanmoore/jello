...
def seed_users():
    ...
    andres = User(
        first_name='Andres', last_name='Miotnik', avatar_id=9, email='andres@aa.io', password='password')
    caroline = User(
        first_name='Caroline', last_name='Gonzalez', avatar_id=10, email='caroline@aa.io', password='password')
